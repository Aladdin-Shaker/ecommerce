...
<div class="card">
    ...
    <!-- /.card-header -->
    <div class="card-body">
        <?php echo Form::open(['url' => aurl('malls'), 'files' => true]); ?>
        ...
        <div class="form-group">
            <?php echo Form::label('address',trans('admin.address')); ?>

            <?php echo Form::text('address', old('address'), ['class' =>
            'form-control']); ?>
        ...
        <?php echo Form::submit(trans('admin.create_mall'), ['class' =>'btn
        btn-primary']); ?>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sniper/Desktop/ecommerc project/Ecommerce/Ecommerce/resources/views/admin/malls/create.blade.php ENDPATH**/ ?>