...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.save_and_continue', function() {
            ...
            $.ajax({
                url: '<?php echo e(aurl('products/' . $product->id)); ?>',
                dataType: 'json',
                type: 'post',
                data: formData,
                beforeSend: function() {
        ...
        $(document).on('click', '.product_copy', function() {
            $.ajax({
                url: '<?php echo e(aurl('products/copy/' . $product->id)); ?>',
                dataType: 'json',
                type: 'POST',
                ...
                success: function(data) {
                   ...
                   setTimeout(function() {
                       window.location.href = '<?php echo e(aurl('products')); ?>/' + data.id + '/edit';
                   }, 3000);
                },
                error(response) {
                    $('.spinner_spinner_copy').addClass('d-none');
...
<div class="card">
    ...
    <!-- /.card-header -->
    <div class="card-body">
        <?php echo Form::open(['url' => aurl('products'), 'method' => 'put',
        ...
        <div class="mb-3">
            ...
            <a href="#"
                class="btn btn-success save_and_continue"><?php echo e(trans('admin.save_continue')); ?>
        ...
        <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="product_info-tab"
                    ...
                    aria-selected="true"><?php echo e(trans('admin.product_info')); ?>
            ...
            <li class="nav-item">
                <a class="nav-link" id="department-tab" data-toggle="tab"
                    ...
                    aria-selected="false"><?php echo e(trans('admin.department')); ?>
            ...
            <li class="nav-item">
                <a class="nav-link" id="product_setting-tab"
                    ...
                    aria-selected="false"><?php echo e(trans('admin.product_setting')); ?>
            ...
            <li class="nav-item">
                <a class="nav-link" id="product_media-tab"
                    ...
                    aria-selected="false"><?php echo e(trans('admin.product_media')); ?>
            ...
            <li class="nav-item">
                <a class="nav-link" id="product_shipping_info-tab"
                    ...
                    aria-selected="false"><?php echo e(trans('admin.product_shipping_info')); ?>
            ...
            <li class="nav-item">
                <a class="nav-link" id="product_more_info-tab"
                    ...
                    aria-selected="false"><?php echo e(trans('admin.product_more_info')); ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo e(trans('admin.delete_this', ['name' =>  $title])); ?>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sniper/Desktop/ecommerc project/Ecommerce/Ecommerce/resources/views/admin/products/product.blade.php ENDPATH**/ ?>