...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="index.html"
                class="nav-link">{{ trans('admin.home') }}</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
    ...
    <!-- Right navbar links -->
    <ul
        class="navbar-nav @if (direction() == 'ltr') ml-auto @else mr-auto @endif">
        ...
        <li class="nav-item dropdown">
            ...
            <div
                ...
                <a href="#" class="dropdown-item">
                    <!-- Message Start -->
                    <div class="media">
                        <img src="{{ url('/design/adminlte/dist/img/user1-128x128.jpg') }}"
                            alt="User Avatar"
                ...
                <a href="#" class="dropdown-item">
                    <!-- Message Start -->
                    <div class="media">
                        <img src="{{ url('/design/adminlte/dist/img/user8-128x128.jpg') }}"
                            alt="User Avatar"
                ...
                <a href="#" class="dropdown-item">
                    <!-- Message Start -->
                    <div class="media">
                        <img src="{{ url('/design/adminlte/dist/img/user3-128x128.jpg') }}"
                            alt="User Avatar"
                            class="img-size-50 img-circle mr-3" />
                        <div class="media-body">
                            <h3 class="dropdown-item-title">
        ...
        <li class="nav-item dropdown">
            ...
            <div
                class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                <span
                    class="dropdown-item dropdown-header">{{ trans('admin.languages') }}</span>
                <div class="dropdown-divider"></div>
