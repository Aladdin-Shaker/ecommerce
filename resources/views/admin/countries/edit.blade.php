...
<div class="card">
    ...
    <!-- /.card-header -->
    <div class="card-body">
        {!! Form::open(['url' => aurl('countries/'. $country->id), 'method'
        =>
        'put', 'files' => true]) !!}
        ...
        <div class="form-group">
            ...
            {!! Form::text('country_name_ar', $country->country_name_ar,
            ['class' =>
            'form-control']) !!}
        </div>
        <div class="form-group">
            ...
            {!! Form::text('country_name_en',$country->country_name_en,
            ['class' =>
            'form-control']) !!}
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <img src="{{Storage::url($country->logo)}}" height="100px"
                width="100px" />
            @endif
        </div>
