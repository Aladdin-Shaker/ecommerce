...
<head>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet"
        href="{{url('/design/style/css/bootstrap.min.css')}}">

    <!-- Font Awesome -->
    <link rel="stylesheet"
        href="{{url('/design/style/css/font-awesome.min.css')}}">

    <!-- Custom CSS -->
    <link rel="stylesheet"
        href="{{url('/design/style/css/owl.carousel.css')}}">
    <link rel="stylesheet" href="{{url('/design/style/style.css')}}">
    <link rel="stylesheet"
        href="{{url('/design/style/css/responsive.css')}}">
